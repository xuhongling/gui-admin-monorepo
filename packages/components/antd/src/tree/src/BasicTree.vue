<script lang="tsx">
  ...
  import { filter, treeToList, eachTree } from './hooks/treeHelper';
  import { useTree } from './hooks/useTree';
  import { useContextMenu } from './hooks/useContextMenu';
  import { CreateContextOptions } from '../../context-menu';
  import { treeEmits, treeProps } from './types/tree';

  import { createBEM, isArray, isBoolean, isEmpty, isFunction, omit, get, difference, cloneDeep } from '@gui-pkg/utils';
  import {  extendSlots, getSlot } from '@gui-pkg/utils';
