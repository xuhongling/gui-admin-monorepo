<template>
  <div :class="bem()">
    <div
      ref="wrap"
      :class="[wrapClass, bem('wrapper'), bem('wrapper', { 'hidden-default': !native }), ]"
      :style="style"
      @scroll="handleScroll"
    >
      <component ref="resize" :is="tag" :class="[bem('view'), viewClass]" :style="viewStyle">
        <slot></slot>
      </component>
    </div>
...
<script lang="ts" setup>
  import { addResizeListener, removeResizeListener, createNamespace, } from '@gui-pkg/utils';
