<template>
  <div class="use-form-demo">
    <a-page-header title="UseForm操作示例" />

    <a-card title="useForm示例">
...
<script lang="ts">
  ...
  import { BasicForm, FormSchema, useForm, type FormProps } from '@gui-pkg/antdcomponents';
